...
import type { Sport } from "$lib/service/sportService";
...
<DropdownMenu.Root>
  ...
  <DropdownMenu.Content>
    ...
    <DropdownMenu.Item
      onclick={() => switchLocation({ page: "sport-details", sportId: sport.id })}
    >
      Zur Detailansicht gehen
    </DropdownMenu.Item>
    <DropdownMenu.Separator />
    <DropdownMenu.Item
      onclick={() => navigator.clipboard.writeText(sport.id.toString())}
    >
      Id kopieren
    </DropdownMenu.Item>
  </DropdownMenu.Content>
